...
public class MainActivity extends Activity {
	...
	private void updateStatus(String msg) {
		...
		switch(mode){
			case 00: 	status = "Stop: ";
						break;
			case 01:	status = "Explore: ";
						break;
			case 10: 	status = "Shortest Path: ";
						break;
			case 11:	status = "Calibrate: ";
						break;
		}
		switch(movement){
			case 00: 	status = status+"Turning 180";
						break;
			case 01:	status = status+"Turning Right";
						break;
			case 10: 	status = status+"Turning Left";
						break;
			case 11:	status = status+"Moving Forward";
						break;	
		}
